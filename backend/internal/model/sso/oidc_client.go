...
type OIDCClient struct {
	...
	ClientID        string `gorm:"type:varchar(100);not null;comment:客户端ID" json:"client_id"`
	...
	RootURL         string `gorm:"type:varchar(255);not null;comment:应用根URL(如https://app.example.com)" json:"root_url"`
